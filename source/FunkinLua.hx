  ...
  public function new(script:String)
  {
    ...
    Lua_helper.add_callback(lua, "isRunning", function(luaFile:String) {
      ...
      if (doPush)
      {
        for (luaInstance in PlayState.instance.luaArray)
        {
          if (luaInstance.scriptName == cervix) return true;
        }
      }
      return false;
    });
    ...
    Lua_helper.add_callback(lua, "getProperty", function(variable:String) {
      ...
      var killMe:Array<String> = variable.split('.');
      if (killMe.length > 1) result = getVarInArray(getPropertyLoopThingWhatever(killMe), killMe[killMe.length - 1]);
      else
    ...
    Lua_helper.add_callback(lua, "soundFadeCancel", function(tag:String) {
      ...
      {
        var theSound:flixel.sound.FlxSound = PlayState.instance.modchartSounds.get(tag);
...
class ModchartText extends FlxText
{
  ...
  public function new(x:Float, y:Float, text:String, width:Float)
  {
    ...
    setFormat(Paths.font("comic-bald.ttf"), 16, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    antialiasing = false;
...
class DebugLuaText extends FlxText
{
  ...
  public function new(text:String, parentGroup:FlxTypedGroup<DebugLuaText>, color:FlxColor)
  {
    ...
    setFormat(Paths.font("comic-bald.ttf"), 16, color, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    antialiasing = false;
    scrollFactor.set();
    borderSize = 1;
  }
