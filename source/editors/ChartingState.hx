  ...
  **/
  ...
  override function create()
  {
      ...
      _song =
        {
          ...
          needsVoices: true,
          arrowSkin: '',
          splashSkin: 'ui/noteSplashes', // idk it would crash if i didn't
          player1: 'bf',
          player2: 'dad',
          gfVersion: 'gf',
          speed: 1,
    ...
    for (i in 0...tipTextArray.length)
    {
      ...
      tipText.y += i * 12;
      tipText.setFormat(Paths.font("comic-bald.ttf"), 14, FlxColor.WHITE, LEFT /*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
  ...
  var check_duetCam:FlxUICheckBox;
  ...
  function addSectionUI():Void
  {
    ...
    check_duetCam = new FlxUICheckBox(10, check_mustHitSection.y + 22, null, null, "Duet Cam", 100);
    check_duetCam.name = 'check_duet';
    check_duetCam.checked = _song.notes[curSec].coolDuetCam;
    // _song.needsVoices = check_mustHit.checked;

    check_altAnim = new FlxUICheckBox(check_duetCam.x + 120, check_duetCam.y, null, null, "Alt Animation", 100);
    ...
    tab_group_section.add(check_duetCam);
  ...
  override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>)
  {
    if (id == FlxUICheckBox.CLICK_EVENT)
    {
      ...
      switch (label)
      {
        ...
        case 'Duet Cam':
          _song.notes[curSec].coolDuetCam = check.checked;
  ...
  function updateSectionUI():Void
  {
    ...
    check_duetCam.checked = sec.coolDuetCam;
  ...
  function updateGrid():Void
  {
    ...
    for (i in _song.notes[curSec].sectionNotes)
    {
      ...
      if (i[3] != null && note.noteType != null && note.noteType.length > 0)
      {
        ...
        daText.setFormat(Paths.font("comic-bald.ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
    ...
    for (i in _song.events)
    {
      if (endThing > i[0] && i[0] >= startThing)
      {
        ...
        daText.setFormat(Paths.font("comic-bald.ttf"), 12, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE_FAST, FlxColor.BLACK);
        daText.antialiasing = false;
        daText.xAdd = -410;
        daText.borderSize = 1;
