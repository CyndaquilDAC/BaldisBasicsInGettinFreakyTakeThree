...
class Paths
{
  ...
  public static var dumpExclusions:Array<String> = ['assets/music/freakyMenu.$SOUND_EXT', 'assets/shared/music/pause.$SOUND_EXT',];
  ...
  public static function returnSound(path:String, key:String, ?library:String)
  {
    ...
    // trace(gottenPath);
    if (!currentTrackedSounds.exists(gottenPath)) #if MODS_ALLOWED
