...
class FreeplayState extends MusicBeatState
{
  ...
  override function create()
  {
    ...
    scoreText.setFormat(Paths.font("comic-bald.ttf"), 32, FlxColor.WHITE, RIGHT);
    ...
    text.setFormat(Paths.font("comic-bald.ttf"), size, FlxColor.WHITE, RIGHT);
  ...
  override function update(elapsed:Float)
  {
    ...
    else if (space)
    {
      if (instPlaying != curSelected)
      {
        ...
        if (PlayState.SONG.needsVoices) vocals = new flixel.sound.FlxSound().loadEmbedded(Paths.voices(PlayState.SONG.song));
        else
